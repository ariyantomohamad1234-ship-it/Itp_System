...
@section('content')
    <div class="fade-up">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <a href="/admin/dashboard" class="btn-back mb-4 d-inline-flex"><i class="fas fa-arrow-left"></i> Kembali ke
                    Dashboard</a>
                <div class="col-lg-7">
                    <a href="/admin/dashboard" class="btn-back mb-3 d-inline-flex"><i class="fas fa-arrow-left"></i>
                        Kembali</a>

                    <div class="premium-form-card">
                        <div class="text-center mb-4">
                            <div class="d-inline-flex align-items-center justify-content-center"
                                style="width: 60px; height: 60px; background: #fef2f2; color: #ef4444; border-radius: 1rem; font-size: 1.5rem; margin-bottom: 1rem;">
                                <i class="fas fa-rocket"></i>
                            </div>
                            <h4 class="fw-bold m-0">Inisialisasi Project Baru</h4>
                            <p class="text-muted small mt-1">Gunakan template atau buat struktur project secara custom</p>
                        </div>
                        ...
                        {{-- MODE SELECTOR --}}
                        <label class="form-label-premium"><i class="fas fa-cogs me-2 text-primary"></i>Mode
                            Pembuatan</label>
                        <div class="mode-selector mb-4">
                            <div class="mode-card active" id="mode-template" onclick="setMode('template')">
                                ...
                                <div class="mode-desc">Struktur ITP otomatis di-generate</div>
                            </div>
                            <div class="mode-card" id="mode-manual" onclick="setMode('manual')">
                                <span class="mode-icon">✏️</span>
                                <div class="mode-title">Custom / Manual</div>
                                <div class="mode-desc">Buat project kosong manual</div>
                            </div>
                        </div>
                        ...
                        <form action="/admin/projects" method="POST">
                            ...
                            {{-- TEMPLATE SELECTOR --}}
                            <div class="template-select-wrapper mb-4" id="template-section">
                                <label class="form-label-premium"><i class="fas fa-layer-group me-2 text-success"></i>Pilih
                                    Template Standar</label>
                                <select name="template_id" id="template_id" class="form-select form-control-premium">
                                    <option value="">-- Pilih Template ITP --</option>
                                ...
                                <div class="template-info mt-2" id="template-info" style="display:none">
                                    <i class="fas fa-check-circle me-1"></i> <span id="template-info-text"></span>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_project" class="form-control form-control-premium"
                                        value="{{ old('nama_project') }}" required
                                        placeholder="Contoh: Mini LNG Vessel Hull 001">
                                    {{-- MODE SELECTOR --}}
                                    ...
                                    <div class="mode-selector">
                                        <div class="mode-card active" id="mode-template" onclick="setMode('template')">
                                            <span class="mode-icon">📋</span>
                                            <div class="mode-title">Dari Template</div>
                                            <div class="mode-desc">Struktur modul, blok, sub-blok & ITP otomatis di-generate
                                            </div>
                                        </div>
                                        <div class="mode-card" id="mode-manual" onclick="setMode('manual')">
                                            <span class="mode-icon">✏️</span>
                                    ...
                                    <form action="/admin/projects" method="POST">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="kode_project" class="form-control form-control-premium"
                                                value="{{ old('kode_project') }}" required placeholder="Contoh: LNG-001">
                                        </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" name="tanggal_kontrak" class="form-control form-control-premium"
                                            value="{{ old('tanggal_kontrak') }}">
                                        <div class="row g-3 mb-3">
                                            <div class="col-4">
                                                <label class="form-label fw-bold" style="font-size:0.85rem">Tanggal
                                                    Kontrak</label>
                                            ...
                                            <div class="col-4">
                                                <label class="form-label fw-bold" style="font-size:0.85rem">Deadline <span
                                        ...
                                        <div id="deadline-warning" class="mb-3" style="display:none">
                                            <div
                                                style="background:#fef3c7;border:1px solid #fbbf24;border-radius:0.5rem;padding:0.6rem 1rem;font-size:0.8rem;color:#92400e">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label-premium">Deadline <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="deadline" id="deadline"
                                                class="form-control form-control-premium" value="{{ old('deadline') }}">
                                        </div>
                                    </div>

                                    <div id="deadline-warning" class="mb-4" style="display:none">
                                        <div
                                            style="background:#fef3c7;border:1px solid #fbbf24;border-radius:0.75rem;padding:0.8rem 1rem;font-size:0.85rem;color:#92400e;display:flex;align-items:center;gap:10px;">
                                    ...
                                    <div class="mb-5">
                                        <label class="form-label-premium">Deskripsi / Catatan Tambahan <span
                                                class="text-muted fw-normal">(opsional)</span></label>
                                        <textarea name="deskripsi" class="form-control form-control-premium" rows="3"
                                            placeholder="Informasi tambahan terkait project...">{{ old('deskripsi') }}</textarea>
                                    </div>

                                    <button type="submit" class="btn btn-submit-premium w-100" id="submit-btn">
